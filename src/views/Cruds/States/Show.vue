    ...
    async showState() {
      try {
        let res = await this.$axios({
          method: "GET",
          url: `states/${this.$route.params?.id}`,
        });
        this.data.name_ar = res.data.data.State.trans?.name?.ar;
        this.data.name_en = res.data.data.State.trans?.name?.en;
        this.data.created_at = res.data.data.State.created_at;
        this.data.active = res.data.data.State.is_active;
      } catch (error) {
        this.loading = false;
