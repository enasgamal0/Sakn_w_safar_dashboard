  ...
  <div class="crud_form_wrapper app_settings_class">
    <div class="table_title_wrapper">
      <div class="title_text_wrapper">
        <h5 style="color: #008274" class="font-weight-bold">{{ $t("SIDENAV.settings.general") }}</h5>
      </div>
    ...
    <div class="single_step_form_content_wrapper">
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <h6 class="mb-5 font-weight-bold" style="color: #008274;">{{ $t("PLACEHOLDERS.appCommission") }}</h6>
          <base-input
            type="number"
            col="6"
